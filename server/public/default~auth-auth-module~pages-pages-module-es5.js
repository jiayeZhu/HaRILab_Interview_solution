...
var RequestManagerService = /** @class */ (function () {
    function RequestManagerService(http) {
        this.http = http;
    }
    RequestManagerService.prototype.newClinicianRegist = function (clinician) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                return [2 /*return*/, this.http.post(baseUrl + "/clinician", clinician).toPromise()];
            });
        });
    };
    RequestManagerService.prototype.login = function (clinician) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                return [2 /*return*/, this.http.post(baseUrl + "/clinician/" + clinician.username + "/session", clinician).toPromise()];
            });
        });
    };
    RequestManagerService.prototype.getUserList = function (page) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                return [2 /*return*/, this.http.get(baseUrl + "/user?page=" + page).toPromise()];
            });
        });
    };
    RequestManagerService.prototype.getAttackList = function (userId, page) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                return [2 /*return*/, this.http.get(baseUrl + "/user/" + userId + "/attack?type=full&source=attacks&count=1&pageSize=10&page=" + page)
                        .toPromise()];
            });
        });
    };
    RequestManagerService.prototype.getWeeklyRecord = function (userId) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function () {
            return tslib__WEBPACK_IMPORTED_MODULE_0__["__generator"](this, function (_a) {
                return [2 /*return*/, this.http.get(baseUrl + "/user/" + userId + "/attack"
                        + ("?from=" + luxon__WEBPACK_IMPORTED_MODULE_3__["DateTime"].local().minus({ days: 6 }).startOf('day').toISO())
                        + ("&to=" + luxon__WEBPACK_IMPORTED_MODULE_3__["DateTime"].local().endOf('day').toISO())).toPromise()];
            });
        });
    };
    RequestManagerService = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
